...
void *my_convert_dec(unsigned long int nb, unsigned long long int base,
                    int level)
{
...
void *converts(unsigned int nb, int base)
{
    ...
    for (cases = 0; str[cases]; cases++, counter++);
